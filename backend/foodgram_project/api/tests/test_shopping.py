...
class ShoppingTest(APITestCase):
    ...
    def setUp(self):
        ...
        self.auth_client1.credentials(
            HTTP_AUTHORIZATION='Token ' + ShoppingTest.token1.key)

        self.auth_client2 = APIClient()
        self.auth_client2.credentials(
            HTTP_AUTHORIZATION='Token ' + ShoppingTest.token2.key)
    ...
    def test_api_recipes_shopping(self):
        ...
        self.assertEqual(UserShoppingCart.objects.count(), count_shopping)
    ...
    def test_api_recipes_get_list(self):
        ...
        UserShoppingCart.objects.create(recipe=recipe2, user=user)
